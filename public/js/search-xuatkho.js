(function () {
    new Vue({
        ...
        ready: function() {
            ...
            this.$on('lydoxuatkho_id', function (value) {
                self.params.lydoxuatkho_id = value || 0;
            });
        ...
        methods: {
            loadData: function() {
                ...
                self.loading = true;
                app.API().get('/api/v1/search/lenhxuatkho', this.params).then(function(response) {
        ...
        components: {
            ...
            'table-list': app.components.XuatkhoList,
