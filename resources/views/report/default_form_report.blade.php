    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <h4 style="text-align:center;text-transform: uppercase">{{$name}}</h4>
                <div class="x_panel">
                    ...
                    @endif
                    <div>
                        <form action="{{$action}}" class="form-horizontal form-label-left" method="get" target="_blank">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">

                            <div class="form-group">
                                <label for="" class="control-label col-md-2 col-xs-12"
                                       style="text-align:left;">Đơn vị cấp trên</label>

                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <input
                                            name="input[donvi_captren]" type="text"
                                            class="form-control"
                                            value="@if(old('input')['donvi_captren']){{old('input')['donvi_captren']}} @endif"
                                            placeholder="">
                                </div>
