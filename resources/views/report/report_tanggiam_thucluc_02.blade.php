            ...
            <div class="col-xs-12">
                <table class="table-bordered" style="border: 2px #aaa solid; margin: auto">
                    <tr>
                        ...
                        @if(count($aryLyDoNhapKho) >0)
                            <th colspan="{{(count($aryLyDoNhapKho))}}" class="text-center">Chi tiết Nhập</th>
                        @endif
                        @if(count($aryLyDoXuatKho) > 0)
                            <th colspan="{{(count($aryLyDoXuatKho))}}" class="text-center">Chi tiết xuất</th>
                        @endif
                    </tr>
                    <tr>
                        <th class="text-center">Tăng</th>
