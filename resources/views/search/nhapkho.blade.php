...
<div class="col-md-12" id="search-nhapkho">
    ...
    <div :class="{'x_panel': true, 'blur': loading}">
        ...
        <div class="x_content">
            <form class="form-horizontal table-custom">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="row form-group">
                            <label for="lydonhapkho_id" class="col-md-4 control-label text-left">Lý do nhập kho</label>
                            <div class="col-md-8">
                                <select-box :data="{{ json_encode($lydonhapkho) }}" model="lydonhapkho_id">
                                </select-box>
                            </div>
                        </div>
            ...
            <h3 class="text-center text-uppercase">Danh sách lệnh nhập kho</h3>

            <div class="row">
                <div class="col-md-12">
                    <total :data="data" text="lệnh nhập kho"></total>
                </div>
            </div>
...
@section('extension.js')
    ...
    <script src="{{ URL::asset('public/js/search-nhapkho.js') }}"></script>
@endsection