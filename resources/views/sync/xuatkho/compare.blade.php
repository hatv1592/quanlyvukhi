            ...
            <div class="x_content">
                ...
                <div class="x_panel">
                    <div class="row body">
                        <div class="col-xs-12">
                            <div>
                                <h3 class="text-center">ĐỐI CHIẾU DỮ LIỆU XUẤT KHO</h3>
                        ...
                        <div class="col-xs-12">
                            @if(!empty($donVi[$donvi_id]) && !empty($compared))
                                <div class="x_panel">
                                    <div class="row body">
                                        <div class="col-xs-12">
                                            <h2 style="text-align: center;font-size: 18px">ĐỐI CHIẾU DỮ LIỆU xuất
                                                KHÓ</h2>
                                            ...
                                            <table class="table table-bordered"
                                                ...
                                                <tr>
                                                    ...
                                                    <th rowspan="2" class="text-center">Căn cứ xuất kho</th>
                                                    <th colspan="6" style="font-size: 15px" class="text-center">Dữ liệu
                                                        của cơ
                                                        quan
                                                    </th>
                                                    <th colspan="2" class="text-center">{{$donVi[$donvi_id]}} xuất</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="text-center">Số lượng đã xuất</th>
                                                    <th class="text-center">Số lệnh</th>
                                                    <th class="text-center">Số lượng đã xuất</th>
                                                </tr>
                                                </tbody>
                                                ...
                                                $stt = 0;
                                                ?>
                                                @foreach($compared as $cancuxuatkho_code => $aryCanCuXuatKhoCode)
                                                    @foreach($aryCanCuXuatKhoCode as $vukhi_id => $vukhi)
                                                        <?php
                                                        $first_vukhi = 0;
                                                        ?>
                                                            ...
                                                            @foreach($nuocsanxuat as $phancap_id => $value)
                                                                @if($value['soluong_cap_tren'] > 0 || $value['soluong'] > 0)
                                                                    ...
                                                                    <tr class="@if($delta <> 0) bg-danger @else bg-success @endif {{empty($value['class'])?'':$value['class']}} ">
                                                                        ...
                                                                        <td class="text-center">{{$cancuxuatkho_code}}</td>
                                                                        <td class="text-center">{{$value['pxk_sophieu_cap_tren']}}</td>
                                                                        ...
                                                                        <td class="text-center">{{$value['pxk_sophieu']}}</td>
